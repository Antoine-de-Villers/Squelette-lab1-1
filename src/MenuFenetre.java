	...
	private void addMenuServeur() {
		...
		demarrerMenuItem.addActionListener(new ActionListener(){
		  public void actionPerformed(ActionEvent arg0) {
			String s = (String)JOptionPane.showInputDialog(null,"Quel est le nom d'h�te et le port du serveur de formes?",JOptionPane.PLAIN_MESSAGE);
		 ...
		 try {
		    ...
		    port = parts[1];
			 ...
			 JOptionPane.showMessageDialog(null,
					    "Vous deevez s�parer le hostname et le numero de port par :",
					    "Error",
